from config_KITTIDC_conventional import args as args_config
import time
import random
import os
...
def update_args(args):
    ...
    if args.mode == 'SDR':
        new_args.lidar_lines = [4, 8, 16, 32, 64]
    elif args.mode == 'conventional':
        new_args.lidar_lines = [64]
...
def main(args):
    ...
    for sd in args.lidar_lines:
        args.lidar_lines_test = sd
        test(args)
